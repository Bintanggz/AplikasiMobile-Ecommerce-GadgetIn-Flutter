      ...
      children: List.generate(
        ...
        (index) => Column(
          children: [
            ListTile(
              onTap: () {
                // Navigate dengan kategori yang dipilih
                final categoryTitle = subCategory[index].title;
                // Skip "Semua Produk" dan "Produk Baru" - tetap ke onSaleScreen tanpa filter
                if (categoryTitle == 'Semua Produk' || categoryTitle == 'Produk Baru') {
