              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "GadgetIn - E-commerce Gadget",
                        style: Theme.of(context).textTheme.titleLarge,
                      ),
                      const SizedBox(height: defaultPadding),
                      const Text(
                        "Selamat datang di GadgetIn! Platform e-commerce terpercaya untuk semua kebutuhan gadget Anda. Jelajahi berbagai produk berkualitas dengan harga terbaik.",
                      ),
                      const SizedBox(height: defaultPadding),
                      Row(
                        children: [
                          Expanded(
                            child: ElevatedButton.icon(
                              ...
                              label:
                                  Text(_isCopied ? "Tautan Disalin" : "Salin Tautan"),
