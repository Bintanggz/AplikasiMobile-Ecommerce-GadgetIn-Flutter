...
class ReviewCard extends StatelessWidget {
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              children: [
                RateBar(star: 5, value: _ratio(numOfFiveStar)),
                RateBar(star: 4, value: _ratio(numOfFourStar)),
                RateBar(star: 3, value: _ratio(numOfThreeStar)),
                RateBar(star: 2, value: _ratio(numOfTwoStar)),
                RateBar(star: 1, value: _ratio(numOfOneStar)),
              ],
            ),
          ),
        ],
  ...
  double _ratio(int count) {
    if (numOfReviews <= 0) return 0;
    final value = count / numOfReviews;
